...
var file_privacy_proto_rawDesc = []byte{
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x50, 0x72, 0x69, 0x76, 0x61, 0x63, 0x79, 0x32, 0xfa, 0x05, 0x0a,
	...
	0x62, 0x6c, 0x69, 0x63, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69, 0x74,
...
var file_privacy_proto_depIdxs = []int32{
	...
	8, // 9: proto.Privacy.CreatePrivacy:output_type -> proto.EmptyResponsePrivacy
	8, // 10: proto.Privacy.UpdatePrivacy:output_type -> proto.EmptyResponsePrivacy
	8, // 11: proto.Privacy.BlockUser:output_type -> proto.EmptyResponsePrivacy
	8, // 12: proto.Privacy.UnBlockUser:output_type -> proto.EmptyResponsePrivacy
	4, // 13: proto.Privacy.CheckIfBlocked:output_type -> proto.BooleanResponse
	4, // 14: proto.Privacy.CheckUserProfilePublic:output_type -> proto.BooleanResponse
	6, // 15: proto.Privacy.GetAllPublicUsers:output_type -> proto.StringArray
