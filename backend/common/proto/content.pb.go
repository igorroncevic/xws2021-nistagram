...
var file_content_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x32, 0xa4, 0x19, 0x0a, 0x07, 0x43, 0x6f,
...
var file_content_proto_depIdxs = []int32{
	...
	23, // 52: proto.Content.GetUserFavoritesOptimized:input_type -> proto.RequestId
	14, // 53: proto.Content.CreateFavorite:input_type -> proto.FavoritesRequest
	14, // 54: proto.Content.RemoveFavorite:input_type -> proto.FavoritesRequest
	5,  // 55: proto.Content.CreateHashtag:input_type -> proto.Hashtag
	23, // 56: proto.Content.GetAllHighlights:input_type -> proto.RequestId
	23, // 57: proto.Content.GetHighlight:input_type -> proto.RequestId
	20, // 58: proto.Content.CreateHighlight:input_type -> proto.Highlight
	23, // 59: proto.Content.RemoveHighlight:input_type -> proto.RequestId
	22, // 60: proto.Content.CreateHighlightStory:input_type -> proto.HighlightRequest
	22, // 61: proto.Content.RemoveHighlightStory:input_type -> proto.HighlightRequest
	27, // 62: proto.Content.CreateContentComplaint:input_type -> proto.ContentComplaint
	26, // 63: proto.Content.CreatePost:output_type -> proto.EmptyResponseContent
	6,  // 64: proto.Content.GetAllPostsReduced:output_type -> proto.ReducedPostArray
	7,  // 65: proto.Content.GetAllPosts:output_type -> proto.PostArray
	7,  // 66: proto.Content.GetPostsForUser:output_type -> proto.PostArray
	26, // 67: proto.Content.RemovePost:output_type -> proto.EmptyResponseContent
	0,  // 68: proto.Content.GetPostById:output_type -> proto.Post
	7,  // 69: proto.Content.SearchContentByLocation:output_type -> proto.PostArray
	7,  // 70: proto.Content.GetPostsByHashtag:output_type -> proto.PostArray
	4,  // 71: proto.Content.GetAllHashtags:output_type -> proto.Hashtags
	26, // 72: proto.Content.CreateStory:output_type -> proto.EmptyResponseContent
	11, // 73: proto.Content.GetAllStories:output_type -> proto.StoriesHome
	9,  // 74: proto.Content.GetStoriesForUser:output_type -> proto.StoriesArray
	9,  // 75: proto.Content.GetMyStories:output_type -> proto.StoriesArray
	26, // 76: proto.Content.RemoveStory:output_type -> proto.EmptyResponseContent
	8,  // 77: proto.Content.GetStoryById:output_type -> proto.Story
	26, // 78: proto.Content.CreateComment:output_type -> proto.EmptyResponseContent
	19, // 79: proto.Content.GetCommentsForPost:output_type -> proto.CommentsArray
	26, // 80: proto.Content.CreateLike:output_type -> proto.EmptyResponseContent
	17, // 81: proto.Content.GetLikesForPost:output_type -> proto.LikesArray
	17, // 82: proto.Content.GetDislikesForPost:output_type -> proto.LikesArray
	7,  // 83: proto.Content.GetUserLikedOrDislikedPosts:output_type -> proto.PostArray
	15, // 84: proto.Content.GetAllCollections:output_type -> proto.CollectionsArray
	12, // 85: proto.Content.GetCollection:output_type -> proto.Collection
	12, // 86: proto.Content.CreateCollection:output_type -> proto.Collection
	26, // 87: proto.Content.RemoveCollection:output_type -> proto.EmptyResponseContent
	13, // 88: proto.Content.GetUserFavorites:output_type -> proto.Favorites
	13, // 89: proto.Content.GetUserFavoritesOptimized:output_type -> proto.Favorites
	26, // 90: proto.Content.CreateFavorite:output_type -> proto.EmptyResponseContent
	26, // 91: proto.Content.RemoveFavorite:output_type -> proto.EmptyResponseContent
	5,  // 92: proto.Content.CreateHashtag:output_type -> proto.Hashtag
	21, // 93: proto.Content.GetAllHighlights:output_type -> proto.HighlightsArray
	20, // 94: proto.Content.GetHighlight:output_type -> proto.Highlight
	20, // 95: proto.Content.CreateHighlight:output_type -> proto.Highlight
	26, // 96: proto.Content.RemoveHighlight:output_type -> proto.EmptyResponseContent
	26, // 97: proto.Content.CreateHighlightStory:output_type -> proto.EmptyResponseContent
	26, // 98: proto.Content.RemoveHighlightStory:output_type -> proto.EmptyResponseContent
	26, // 99: proto.Content.CreateContentComplaint:output_type -> proto.EmptyResponseContent
