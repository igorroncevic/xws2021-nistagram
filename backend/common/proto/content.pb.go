...
var file_content_proto_rawDesc = []byte{
	...
	0x6c, 0x61, 0x69, 0x6e, 0x74, 0x73, 0x32, 0x91, 0x1a, 0x0a, 0x07, 0x43, 0x6f, 0x6e, 0x74, 0x65,
	...
	0x70, 0x6c, 0x61, 0x69, 0x6e, 0x74, 0x2f, 0x67, 0x65, 0x74, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69,
...
var file_content_proto_depIdxs = []int32{
	...
	26, // 66: proto.Content.CreatePost:output_type -> proto.EmptyResponseContent
	6,  // 67: proto.Content.GetAllPostsReduced:output_type -> proto.ReducedPostArray
	7,  // 68: proto.Content.GetAllPosts:output_type -> proto.PostArray
	7,  // 69: proto.Content.GetPostsForUser:output_type -> proto.PostArray
	26, // 70: proto.Content.RemovePost:output_type -> proto.EmptyResponseContent
	0,  // 71: proto.Content.GetPostById:output_type -> proto.Post
	7,  // 72: proto.Content.SearchContentByLocation:output_type -> proto.PostArray
	7,  // 73: proto.Content.GetPostsByHashtag:output_type -> proto.PostArray
	4,  // 74: proto.Content.GetAllHashtags:output_type -> proto.Hashtags
	26, // 75: proto.Content.CreateStory:output_type -> proto.EmptyResponseContent
	11, // 76: proto.Content.GetAllStories:output_type -> proto.StoriesHome
	9,  // 77: proto.Content.GetStoriesForUser:output_type -> proto.StoriesArray
	9,  // 78: proto.Content.GetMyStories:output_type -> proto.StoriesArray
	26, // 79: proto.Content.RemoveStory:output_type -> proto.EmptyResponseContent
	8,  // 80: proto.Content.GetStoryById:output_type -> proto.Story
	26, // 81: proto.Content.CreateComment:output_type -> proto.EmptyResponseContent
	19, // 82: proto.Content.GetCommentsForPost:output_type -> proto.CommentsArray
	26, // 83: proto.Content.CreateLike:output_type -> proto.EmptyResponseContent
	17, // 84: proto.Content.GetLikesForPost:output_type -> proto.LikesArray
	17, // 85: proto.Content.GetDislikesForPost:output_type -> proto.LikesArray
	7,  // 86: proto.Content.GetUserLikedOrDislikedPosts:output_type -> proto.PostArray
	15, // 87: proto.Content.GetAllCollections:output_type -> proto.CollectionsArray
	12, // 88: proto.Content.GetCollection:output_type -> proto.Collection
	12, // 89: proto.Content.CreateCollection:output_type -> proto.Collection
	26, // 90: proto.Content.RemoveCollection:output_type -> proto.EmptyResponseContent
	13, // 91: proto.Content.GetUserFavorites:output_type -> proto.Favorites
	13, // 92: proto.Content.GetUserFavoritesOptimized:output_type -> proto.Favorites
	26, // 93: proto.Content.CreateFavorite:output_type -> proto.EmptyResponseContent
	26, // 94: proto.Content.RemoveFavorite:output_type -> proto.EmptyResponseContent
	5,  // 95: proto.Content.CreateHashtag:output_type -> proto.Hashtag
	21, // 96: proto.Content.GetAllHighlights:output_type -> proto.HighlightsArray
	20, // 97: proto.Content.GetHighlight:output_type -> proto.Highlight
	20, // 98: proto.Content.CreateHighlight:output_type -> proto.Highlight
	26, // 99: proto.Content.RemoveHighlight:output_type -> proto.EmptyResponseContent
	26, // 100: proto.Content.CreateHighlightStory:output_type -> proto.EmptyResponseContent
	26, // 101: proto.Content.RemoveHighlightStory:output_type -> proto.EmptyResponseContent
	26, // 102: proto.Content.CreateContentComplaint:output_type -> proto.EmptyResponseContent
	28, // 103: proto.Content.GetAllContentComplaints:output_type -> proto.ContentComplaintArray
