...
var file_content_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x69, 0x65, 0x73, 0x22, 0x6b, 0x0a, 0x0a, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74,
	...
	0x6c, 0x61, 0x69, 0x6e, 0x74, 0x73, 0x32, 0xcf, 0x1b, 0x0a, 0x07, 0x43, 0x6f, 0x6e, 0x74, 0x65,
	...
	0x65, 0x6a, 0x65, 0x63, 0x74, 0x3a, 0x01, 0x2a, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69, 0x74, 0x68,
...
var file_content_proto_depIdxs = []int32{
	...
	0,  // 18: proto.Collection.posts:type_name -> proto.Post
	12, // 19: proto.Favorites.collections:type_name -> proto.Collection
	0,  // 20: proto.Favorites.unclassified:type_name -> proto.Post
	12, // 21: proto.CollectionsArray.collections:type_name -> proto.Collection
	16, // 22: proto.LikesArray.likes:type_name -> proto.Like
	29, // 23: proto.Comment.createdAt:type_name -> google.protobuf.Timestamp
	18, // 24: proto.CommentsArray.comments:type_name -> proto.Comment
	8,  // 25: proto.Highlight.stories:type_name -> proto.Story
	20, // 26: proto.HighlightsArray.highlights:type_name -> proto.Highlight
	27, // 27: proto.ContentComplaintArray.content_complaints:type_name -> proto.ContentComplaint
	0,  // 28: proto.Content.CreatePost:input_type -> proto.Post
	25, // 29: proto.Content.GetAllPostsReduced:input_type -> proto.EmptyRequestContent
	25, // 30: proto.Content.GetAllPosts:input_type -> proto.EmptyRequestContent
	23, // 31: proto.Content.GetPostsForUser:input_type -> proto.RequestId
	23, // 32: proto.Content.RemovePost:input_type -> proto.RequestId
	23, // 33: proto.Content.GetPostById:input_type -> proto.RequestId
	24, // 34: proto.Content.SearchContentByLocation:input_type -> proto.SearchLocationRequest
	5,  // 35: proto.Content.GetPostsByHashtag:input_type -> proto.Hashtag
	25, // 36: proto.Content.GetAllHashtags:input_type -> proto.EmptyRequestContent
	8,  // 37: proto.Content.CreateStory:input_type -> proto.Story
	25, // 38: proto.Content.GetAllStories:input_type -> proto.EmptyRequestContent
	23, // 39: proto.Content.GetStoriesForUser:input_type -> proto.RequestId
	23, // 40: proto.Content.GetMyStories:input_type -> proto.RequestId
	23, // 41: proto.Content.RemoveStory:input_type -> proto.RequestId
	23, // 42: proto.Content.GetStoryById:input_type -> proto.RequestId
	18, // 43: proto.Content.CreateComment:input_type -> proto.Comment
	23, // 44: proto.Content.GetCommentsForPost:input_type -> proto.RequestId
	16, // 45: proto.Content.CreateLike:input_type -> proto.Like
	23, // 46: proto.Content.GetLikesForPost:input_type -> proto.RequestId
	23, // 47: proto.Content.GetDislikesForPost:input_type -> proto.RequestId
	16, // 48: proto.Content.GetUserLikedOrDislikedPosts:input_type -> proto.Like
	23, // 49: proto.Content.GetAllCollections:input_type -> proto.RequestId
	23, // 50: proto.Content.GetCollection:input_type -> proto.RequestId
	12, // 51: proto.Content.CreateCollection:input_type -> proto.Collection
	23, // 52: proto.Content.RemoveCollection:input_type -> proto.RequestId
	23, // 53: proto.Content.GetUserFavorites:input_type -> proto.RequestId
	23, // 54: proto.Content.GetUserFavoritesOptimized:input_type -> proto.RequestId
	14, // 55: proto.Content.CreateFavorite:input_type -> proto.FavoritesRequest
	14, // 56: proto.Content.RemoveFavorite:input_type -> proto.FavoritesRequest
	5,  // 57: proto.Content.CreateHashtag:input_type -> proto.Hashtag
	23, // 58: proto.Content.GetAllHighlights:input_type -> proto.RequestId
	23, // 59: proto.Content.GetHighlight:input_type -> proto.RequestId
	20, // 60: proto.Content.CreateHighlight:input_type -> proto.Highlight
	23, // 61: proto.Content.RemoveHighlight:input_type -> proto.RequestId
	22, // 62: proto.Content.CreateHighlightStory:input_type -> proto.HighlightRequest
	22, // 63: proto.Content.RemoveHighlightStory:input_type -> proto.HighlightRequest
	27, // 64: proto.Content.CreateContentComplaint:input_type -> proto.ContentComplaint
	23, // 65: proto.Content.DeleteComplaintByUserId:input_type -> proto.RequestId
	25, // 66: proto.Content.GetAllContentComplaints:input_type -> proto.EmptyRequestContent
	23, // 67: proto.Content.RejectById:input_type -> proto.RequestId
	26, // 68: proto.Content.CreatePost:output_type -> proto.EmptyResponseContent
	6,  // 69: proto.Content.GetAllPostsReduced:output_type -> proto.ReducedPostArray
	7,  // 70: proto.Content.GetAllPosts:output_type -> proto.PostArray
	7,  // 71: proto.Content.GetPostsForUser:output_type -> proto.PostArray
	26, // 72: proto.Content.RemovePost:output_type -> proto.EmptyResponseContent
	0,  // 73: proto.Content.GetPostById:output_type -> proto.Post
	7,  // 74: proto.Content.SearchContentByLocation:output_type -> proto.PostArray
	7,  // 75: proto.Content.GetPostsByHashtag:output_type -> proto.PostArray
	4,  // 76: proto.Content.GetAllHashtags:output_type -> proto.Hashtags
	26, // 77: proto.Content.CreateStory:output_type -> proto.EmptyResponseContent
	11, // 78: proto.Content.GetAllStories:output_type -> proto.StoriesHome
	9,  // 79: proto.Content.GetStoriesForUser:output_type -> proto.StoriesArray
	9,  // 80: proto.Content.GetMyStories:output_type -> proto.StoriesArray
	26, // 81: proto.Content.RemoveStory:output_type -> proto.EmptyResponseContent
	8,  // 82: proto.Content.GetStoryById:output_type -> proto.Story
	26, // 83: proto.Content.CreateComment:output_type -> proto.EmptyResponseContent
	19, // 84: proto.Content.GetCommentsForPost:output_type -> proto.CommentsArray
	26, // 85: proto.Content.CreateLike:output_type -> proto.EmptyResponseContent
	17, // 86: proto.Content.GetLikesForPost:output_type -> proto.LikesArray
	17, // 87: proto.Content.GetDislikesForPost:output_type -> proto.LikesArray
	7,  // 88: proto.Content.GetUserLikedOrDislikedPosts:output_type -> proto.PostArray
	15, // 89: proto.Content.GetAllCollections:output_type -> proto.CollectionsArray
	12, // 90: proto.Content.GetCollection:output_type -> proto.Collection
	12, // 91: proto.Content.CreateCollection:output_type -> proto.Collection
	26, // 92: proto.Content.RemoveCollection:output_type -> proto.EmptyResponseContent
	13, // 93: proto.Content.GetUserFavorites:output_type -> proto.Favorites
	13, // 94: proto.Content.GetUserFavoritesOptimized:output_type -> proto.Favorites
	26, // 95: proto.Content.CreateFavorite:output_type -> proto.EmptyResponseContent
	26, // 96: proto.Content.RemoveFavorite:output_type -> proto.EmptyResponseContent
	5,  // 97: proto.Content.CreateHashtag:output_type -> proto.Hashtag
	21, // 98: proto.Content.GetAllHighlights:output_type -> proto.HighlightsArray
	20, // 99: proto.Content.GetHighlight:output_type -> proto.Highlight
	20, // 100: proto.Content.CreateHighlight:output_type -> proto.Highlight
	26, // 101: proto.Content.RemoveHighlight:output_type -> proto.EmptyResponseContent
	26, // 102: proto.Content.CreateHighlightStory:output_type -> proto.EmptyResponseContent
	26, // 103: proto.Content.RemoveHighlightStory:output_type -> proto.EmptyResponseContent
	26, // 104: proto.Content.CreateContentComplaint:output_type -> proto.EmptyResponseContent
	26, // 105: proto.Content.DeleteComplaintByUserId:output_type -> proto.EmptyResponseContent
	28, // 106: proto.Content.GetAllContentComplaints:output_type -> proto.ContentComplaintArray
	26, // 107: proto.Content.RejectById:output_type -> proto.EmptyResponseContent
