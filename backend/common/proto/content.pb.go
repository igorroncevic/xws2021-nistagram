...
var file_content_proto_rawDesc = []byte{
	...
	0x65, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x32, 0xb6, 0x18, 0x0a, 0x07, 0x43, 0x6f, 0x6e,
...
var file_content_proto_depIdxs = []int32{
	...
	26, // 62: proto.Content.CreatePost:output_type -> proto.EmptyResponseContent
	6,  // 63: proto.Content.GetAllPostsReduced:output_type -> proto.ReducedPostArray
	7,  // 64: proto.Content.GetAllPosts:output_type -> proto.PostArray
	7,  // 65: proto.Content.GetPostsForUser:output_type -> proto.PostArray
	26, // 66: proto.Content.RemovePost:output_type -> proto.EmptyResponseContent
	0,  // 67: proto.Content.GetPostById:output_type -> proto.Post
	7,  // 68: proto.Content.SearchContentByLocation:output_type -> proto.PostArray
	7,  // 69: proto.Content.GetPostsByHashtag:output_type -> proto.PostArray
	4,  // 70: proto.Content.GetAllHashtags:output_type -> proto.Hashtags
	26, // 71: proto.Content.CreateStory:output_type -> proto.EmptyResponseContent
	11, // 72: proto.Content.GetAllStories:output_type -> proto.StoriesHome
	9,  // 73: proto.Content.GetStoriesForUser:output_type -> proto.StoriesArray
	9,  // 74: proto.Content.GetMyStories:output_type -> proto.StoriesArray
	26, // 75: proto.Content.RemoveStory:output_type -> proto.EmptyResponseContent
	8,  // 76: proto.Content.GetStoryById:output_type -> proto.Story
	26, // 77: proto.Content.CreateComment:output_type -> proto.EmptyResponseContent
	19, // 78: proto.Content.GetCommentsForPost:output_type -> proto.CommentsArray
	26, // 79: proto.Content.CreateLike:output_type -> proto.EmptyResponseContent
	17, // 80: proto.Content.GetLikesForPost:output_type -> proto.LikesArray
	17, // 81: proto.Content.GetDislikesForPost:output_type -> proto.LikesArray
	7,  // 82: proto.Content.GetUserLikedOrDislikedPosts:output_type -> proto.PostArray
	15, // 83: proto.Content.GetAllCollections:output_type -> proto.CollectionsArray
	12, // 84: proto.Content.GetCollection:output_type -> proto.Collection
	12, // 85: proto.Content.CreateCollection:output_type -> proto.Collection
	26, // 86: proto.Content.RemoveCollection:output_type -> proto.EmptyResponseContent
	13, // 87: proto.Content.GetUserFavorites:output_type -> proto.Favorites
	13, // 88: proto.Content.GetUserFavoritesOptimized:output_type -> proto.Favorites
	26, // 89: proto.Content.CreateFavorite:output_type -> proto.EmptyResponseContent
	26, // 90: proto.Content.RemoveFavorite:output_type -> proto.EmptyResponseContent
	5,  // 91: proto.Content.CreateHashtag:output_type -> proto.Hashtag
	21, // 92: proto.Content.GetAllHighlights:output_type -> proto.HighlightsArray
	20, // 93: proto.Content.GetHighlight:output_type -> proto.Highlight
	20, // 94: proto.Content.CreateHighlight:output_type -> proto.Highlight
	26, // 95: proto.Content.RemoveHighlight:output_type -> proto.EmptyResponseContent
	26, // 96: proto.Content.CreateHighlightStory:output_type -> proto.EmptyResponseContent
	26, // 97: proto.Content.RemoveHighlightStory:output_type -> proto.EmptyResponseContent
