...
func request_Privacy_GetAllPublicUsers_0(ctx context.Context, marshaler runtime.Marshaler, client PrivacyClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq EmptyRequestPrivacy
	var metadata runtime.ServerMetadata
...
var (
	...
	pattern_Privacy_GetAllPublicUsers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "privacy", "public"}, ""))
)
